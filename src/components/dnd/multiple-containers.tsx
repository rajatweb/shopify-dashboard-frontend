...
const MultipleContainers = () => {
    const [containers, setContainers] = useState<DNDType[]>([
        // { id: "xyz1", title: "Container 1", items: [ { id: '1', title: 'Item 1' }, { id: '2', title: 'Item 2' }, { id: '3', title: 'Item 3' } ]},
        // { id: "c2", title: "Container 2", items: [ { id: '4', title: 'Item 4' }, { id: '5', title: 'Item 5' }, { id: '6', title: 'Item 6' } ]}
    ]);
    ...
    return (
        <div className='mx-auto max-w-7xl py-10'>
            {/* Add Container Modal */}
            <Button onClick={() => setShowAddContainerModal(!showAddContainerModal)}>Add container</Button>
            <Modal
                isOpen={showAddContainerModal}
                title={'Add Container'}
                description={''}
                onClose={() => { }}
            >
            ...
            <div className='flex items-center justify-between gap-y-2'>
                <h1 className='text-gray-800 text-3xl font-bold'>MultiContainer</h1>
            </div>
            <div className='mt-10'>
